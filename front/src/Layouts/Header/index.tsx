...
import { AUTH_PATH, BOARD_DETAIL_RATH, BOARD_UPDATE_RATH, BOARD_WRITE_RATH, MAIN_PATH, SEARCH_PATH, USER_PAGE_PATH } from 'src/constants';
import './style.css';
...
export default function Header() {
  ...
  const showSearch = !pathname.includes(USER_PAGE_PATH('')) && pathname !== BOARD_WRITE_RATH() && !pathname.includes(BOARD_UPDATE_RATH(''));
  ...
  const showUpload = pathname === BOARD_WRITE_RATH() || pathname.includes(BOARD_UPDATE_RATH(''));
